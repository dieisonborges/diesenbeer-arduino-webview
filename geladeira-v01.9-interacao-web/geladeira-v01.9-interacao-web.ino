  ...
  if (client) {
    while (client.connected())
    {
      if (client.available())
      {
        ...
        client.print("<a href='#' class='btn btn-primary float-left'><i class='fas fa-chevron-circle-up'></i></a>");
        client.print("<a href='#' class='btn btn-primary float-right'><i class='fas fa-chevron-circle-down'></i></a>");
        client.print("</div>");
        client.print("<a href='#' class='small-box-footer'>Desligar Geladeira <i class='fas fa-power-off'></i></a>");
        client.print("<a href='#' class='small-box-footer'>Usar Termostato <i class='fas fa-temperature-low'></i></a>");
        ...
        client.print("</div>");
        client.print("<div class='card-footer col-md-12'>");
        client.print("<a href='#' class='btn btn-default float-left'><i class='fas fa-chevron-circle-up'></i></a>");
        client.print("<a href='#' class='btn btn-default float-right'><i class='fas fa-chevron-circle-down'></i></a>");
        client.print("</div>");
        client.print("<a href='#' class='small-box-footer'>Desligar Resistência <i class='fas fa-power-off'></i></a>");
        client.print("<a href='#' class='small-box-footer'>Ferver Panela <i class='fas fa-fire text-red'></i></a>");
        client.print("</div></div>");    
        ...
        client.print("</div>");
        client.print("<div class='card-footer col-md-12'>");
        client.print("<a href='#' class='btn btn-default float-left'><i class='fas fa-stopwatch'></i></a>");
        client.print("<a href='#' class='btn btn-default float-right'><i class='far fa-stop-circle'></i></a>");
        client.print("</div>");
        client.print("<a href='#' class='small-box-footer'>Iniciar/Reiniciar <i class='fas fa-stopwatch'></i></a>");
        client.print("<a href='#' class='small-box-footer'>Parar <i class='far fa-stop-circle'></i></a>");
        client.print("</div></div>");   
        ...
        client.print("<p>Recirculação</p>");
        client.print("</div>");
        client.print("<div class='icon'> ");
        client.print("<i class='ion ion-refresh'></i>");
        client.print("</div>");
        client.print("<div class='card-footer col-md-12'>");
        client.print("<a href='#' class='btn btn-default float-left'><i class='fas fa-play-circle'></i></a>");
        client.print("<a href='#' class='btn btn-default float-right'><i class='far fa-stop-circle'></i></a>");
        client.print("</div>");
        client.print("<a href='#' class='small-box-footer text-dark'>Ligar Bomba <i class='fas fa-play-circle'></i></a>");
        client.print("<a href='#' class='small-box-footer text-dark'>Desligar Bomba <i class='far fa-stop-circle'></i></a>");
        client.print("</div></div>");   
