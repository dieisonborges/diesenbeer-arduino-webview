...
int ledPin = 48; //PINO DIGITAL UTILIZADO PELO LED
int ledPin2 = 46; //PINO DIGITAL UTILIZADO PELO LED

int ledPin3 = 31; //PINO DIGITAL UTILIZADO PELO LED
int ledPin4 = 33; //PINO DIGITAL UTILIZADO PELO LED
int ledPin5 = 35; //PINO DIGITAL UTILIZADO PELO LED
int ledPin6 = 37; //PINO DIGITAL UTILIZADO PELO LED
...
void setup(){
  ...
  pinMode(ledPin4, OUTPUT); //DEFINE O PINO COMO SAÍDA
  digitalWrite(ledPin4, LOW); //LED INICIA DESLIGADO
  pinMode(ledPin5, OUTPUT); //DEFINE O PINO COMO SAÍDA
  digitalWrite(ledPin5, LOW); //LED INICIA DESLIGADO
  pinMode(ledPin6, OUTPUT); //DEFINE O PINO COMO SAÍDA
  digitalWrite(ledPin6, LOW); //LED INICIA DESLIGADO
  }
void loop(){
    ...
    if (readString.length() < 100) //SE O ARRAY FOR MENOR QUE 100, FAZ
      {
        ...
        if(readString.indexOf("ledParam=1") >0){ //SE ENCONTRAR O PARÂMETRO "ledParam=1", FAZ
             ...
             digitalWrite(ledPin4, HIGH); //LIGA O LED
             digitalWrite(ledPin5, HIGH); //LIGA O LED
             digitalWrite(ledPin6, HIGH); //LIGA O LED
             ...
             digitalWrite(ledPin4, LOW); //DESLIGA O LED
             digitalWrite(ledPin5, LOW); //DESLIGA O LED
             digitalWrite(ledPin6, LOW); //DESLIGA O LED
